...
<html>
    <head>
        ...
        <title>Data for Dr. Mann</title>
    </head>

    <body>
        <h2>Data for Dr. Mann</h2>

        <div id="drmann" style="width:25000px;height:600px"></div>
        <script language="javascript" type="text/javascript" src="js/drmann.js"></script>
