...
$(function () {
    ...
    $("#temp2").bind("plothover", function (event, pos, item) {
    ...
    function fetchTemp2() {
        ...
        setTimeout(fetchTemp2, 120000);

    }

    setTimeout(fetchTemp2, 10);
});
