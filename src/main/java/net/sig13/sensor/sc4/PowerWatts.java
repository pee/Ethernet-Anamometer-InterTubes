 ...
 * @author pee
 */
public class PowerWatts extends HttpServlet {

    private static final Logger logger = Logger.getLogger(PowerWatts.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            boolean ex = s.execute("(select * from 00252f216137_ted5kpower order by time desc limit 5000 ) order by time");
